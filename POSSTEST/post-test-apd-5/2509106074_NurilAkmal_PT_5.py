...
while True:
    ...
    if pilihan == '4':
        ...
        if user in daftaruser:
            user_index = daftaruser.index(user)
            if pwd == pwd_user[user_index]:
                ...
                while True:
                    ...
                    if choice == '1':
                        ...
                        for event in events:
                            if event[3] == "ongoing":
                                print(f"ID: {event[0]}, Nama: {event[1]}, Hadiah: {event[2]}")
                        
                        try:
                            event_id = int(input("Masukkan ID event yang ingin diikuti: "))
                            for event in events:
                                if event[0] == event_id and event[3] == "ongoing":
                                    if user not in event[4]:
                                        event[4].append(user)
                                        print(f"Berhasil mendaftar ke event {event[1]}!")
                                    else:
        ...
        # Cek login untuk admin
            ...
            admin_index = admin.index(user)
            if pwd == password[admin_index]:
                ...
                while True:
                    ...
                    if choice == '1':
                        ...
                        # Perbaikan 3: Validasi status event
                        while True:
                        ...
                        try:
                            ...
                            for event in events:
                                if event[0] == event_id:
                                    ...
                                    # Perbaikan 4: Validasi status event pada update
                                    while True:
